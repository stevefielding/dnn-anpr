...
/*
    Based on examples/dnn_mmod_ex.cpp
    Small mods to work with lplate images
    Not very successful. Can't seem to get the window size correct
*/
...
int main(int argc, char** argv) try
{
    ...
    load_image_dataset(images_train, face_boxes_train, faces_directory+"/plateAnnotations_train_small.xml");
    load_image_dataset(images_test, face_boxes_test, faces_directory+"/plateAnnotations_test_small.xml");
